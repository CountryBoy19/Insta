...
$proxy_id 	= (isset($parameters[1])) ? $parameters[1] : false;
...
if(!empty($_POST)) {
	...
	if(empty($_SESSION['error'])) {
		$database->query("INSERT INTO `proxies` (`address`, `port`, `username`, `password`, `note`, `method`) VALUES ('{$_POST['address']}', '{$_POST['port']}', '{$_POST['username']}', '{$_POST['password']}', '{$_POST['note']}', '{$_POST['method']}')");
