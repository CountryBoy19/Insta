...
<div class="d-flex justify-content-between">
    ...
    <div class="btn-group">
        <div class="btn-group">
            <button type="button" class="btn btn-instagram dropdown-toggle" data-toggle="dropdown"><i class="fa fa-table"></i> ' . $language->directory->display->order_by . '</button>
                ...
                <div class="form-inline d-flex justify-content-between">
                    <div class="form-group">
                        <select class="form-control" name="order_by_filter">
                            ...
                            <option value="username">' . $language->report->display->username . '</option>
                            <option value="followers">' . $language->report->display->followers . '</option>
                            <option value="following">' . $language->report->display->following . '</option>
                            <option value="uploads">' . $language->report->display->uploads . '</option>
                            <option value="average_engagement_rate">' . $language->report->display->average_engagement_rate . '</option>
                        </select>
                    </div>
        ...
        <div class="btn-group">
            <button type="button" class="btn btn-instagram dropdown-toggle" data-toggle="dropdown"><i class="fas fa-pencil-alt"></i> ' . $language->directory->display->bio . '</button>
        ...
        <div class="btn-group">
            <button type="button" class="btn btn-instagram dropdown-toggle" data-toggle="dropdown"><i class="fa fa-users"></i> ' . $language->directory->display->followers . '</button>
            <div class="dropdown-menu px-3 py-2" data-no-toggle>
        ...
        <div class="btn-group">
            <button type="button" class="btn btn-instagram dropdown-toggle" data-toggle="dropdown"><i class="fa fa-comments"></i> ' . $language->directory->display->engagement . '</button>
            <div class="dropdown-menu px-3 py-2" data-no-toggle>
...
while($source_account = $reports_result->fetch_object()):
    ...
    if($source_account->is_private):
        $html .= '<span data-toggle="tooltip" title="' . $language->report->display->private . '"><i class="fa fa-lock user-private-badge"></i></span>';
    endif;

    if($source_account->is_verified):
        $html .= '<span data-toggle="tooltip" title="' . $language->report->display->verified . '"><i class="fa fa-check-circle user-verified-badge"></i></span>';
    endif;

    if($source_account->owner_user_id):
        $html .= '<span data-toggle="tooltip" title="' . $language->global->verified . '"><i class="fa fa-check owner-verified-badge"></i></span>';
    endif;
    $html .= '</h5>';
    ...
    $html .= '
                <div class="col-md-12 col-lg-5 d-flex justify-content-around align-items-center mt-4 mt-lg-0">
                    <div class="col d-flex flex-column justify-content-center">
                        ...
                        <p class="directory-header-number ">' . number_format($source_account->followers) . '</p>
                    </div>

                    <div class="col d-flex flex-column justify-content-center">
                        <strong>' . $language->report->display->uploads . '</strong>
                        <p class="directory-header-number ">' . number_format($source_account->uploads) .'</p>
                    </div>

                    <div class="col d-flex flex-column justify-content-center">
                        <strong>' . $language->report->display->engagement_rate . '</strong>
                        <p class="directory-header-number ">
                            ' . (($source_account->is_private) ? 'N/A' : number_format($source_account->average_engagement_rate, 2)) . '%                               
                        </p>
                    </div>
                </div>
            </div>
