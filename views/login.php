		...
		<div class="card-body">
			...
			<form action="" method="post" role="form">
				<div class="form-group mt-5">
					<input type="text" name="username" class="form-control form-control-border" placeholder="<?= $language->login->input->username ?>" value="<?= $login_username ?>" />
				</div>

				<div class="form-group mt-5">
					<input type="password" name="password" class="form-control form-control-border" placeholder="<?= $language->login->input->password ?>" />
				</div>
